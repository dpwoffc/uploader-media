...
![WhatsApp API](https://files.catbox.moe/sgqpjj.jpg)

</div>

[![npm version](https://img.shields.io/npm/v/@vkazee/baileys?style=for-the-badge&color=00d26a)](https://www.npmjs.com/package/@vkazee/baileys)
[![Downloads](https://img.shields.io/npm/dm/@vkazee/baileys?style=for-the-badge&color=blue)](https://www.npmjs.com/package/@vkazee/baileys)
[![License](https://img.shields.io/badge/License-MIT-red.svg?style=for-the-badge)](https://opensource.org/licenses/MIT)
[![WhatsApp](https://img.shields.io/badge/Join-WhatsApp%20Channel-25D366?style=for-the-badge&logo=whatsapp&logoColor=white)](https://whatsapp.com/channel/0029Vacg8Tr96H4Lp5FlBO0G)
...
```bash
npm install @vkazee/baileys
```

Use the edge version (no guarantee of stability, but latest fixes + features)
```bash
yarn add @vkazee/baileys@latest
```

Then import your code using:
```javascript
const { default: makeWASocket } = require("@vkazee/baileys")
```

<details>
<summary><strong style="font-size: 22px">📚 Documentation Index</strong></summary>

Here’s a complete list of features, guides, and examples available in this library.  
Click to expand and jump to any section you need!
...
- [User Querys](#user-querys)
  ...
  - [Fetch Bussines Profile](#fetch-bussines-profile-such-as-description-or-category)
  - [Fetch Someone's Presence](#fetch-someones-presence-if-theyre-typing-or-online)
- [Change Profile](#change-profile)
  - [Change Profile Status](#change-profile-status)
  - [Change Profile Name](#change-profile-name)
  - [Change Display Picture](#change-display-picture-groups-too)
...
```javascript
const makeWASocket = require("@vkazee/baileys").default;
const { useMultiFileAuthState } = require("@vkazee/baileys");
...
```javascript
const makeWASocket = require("@vkazee/baileys").default;
const { useMultiFileAuthState, makeCacheableSignalKeyStore } = require("@vkazee/baileys");
...
```javascript
const makeWASocket = require("@vkazee/baileys").default;
const { DisconnectReason, useMultiFileAuthState } = require("@vkazee/baileys");
...
```javascript
const makeWASocket = require("@vkazee/baileys").default;
const { makeInMemoryStore } = require("@vkazee/baileys");
...
const { downloadMediaMessage, getContentType } = require("@vkazee/baileys");
